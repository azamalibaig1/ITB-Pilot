...
st.set_page_config(page_title="BacloRisk: ITB Mechanical Complication Predictor", page_icon="🧠")
bundle = joblib.load("itb_mechanical_model_v1.joblib")
model = bundle["model"]

st.title("BacloRisk: ITB Mechanical Complication Predictor")
...
indication = st.selectbox("Indication for current surgery", ["New insertion", "Replacement", "Revision"])
placement = st.selectbox("Pump placement position", ["Subcutaneous", "Subfascial", "Submuscular"])
